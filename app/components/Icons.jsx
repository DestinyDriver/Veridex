...
export const ClockIcon = ({ className = "h-7 w-7" }) => (
...
export const GlobeIcon = ({ className = "h-7 w-7" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <circle cx="12" cy="12" r="9" />
    <path d="M3 12h18" />
...
export const MaterialImage = ({ className = "h-6 w-6 text-white" }) => (
...
export const MaterialMovie = ({ className = "h-6 w-6 text-white" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export const MaterialBulb = ({ className = "h-6 w-6 text-white" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export const Chevron = ({ open }) => (
  <svg
    viewBox="0 0 24 24"
    className="w-5 h-5 text-[#f3ead8] shrink-0 transition-transform duration-300"
