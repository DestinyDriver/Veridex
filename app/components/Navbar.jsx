...
export default function Navbar() {
  ...
  const fgMuted = scrolledPastHero ? "rgba(243,234,216,0.9)" : "rgba(10,9,7,0.85)";
      ...
      <div className="flex items-center justify-between">
        <div className="liquid-glass w-12 h-12 rounded-full flex items-center justify-center">
          <span
            ...
            style={{ marginTop: "-2px", color: fg, transition: "color 0.4s ease" }}
          >
            a
          </span>
        </div>
        ...
        <div className="hidden md:flex liquid-glass rounded-full px-1.5 py-1.5 items-center">
          <div className="relative z-10 flex items-center">
            ...
            <a
              ...
              style={{ background: ctaBg, color: ctaFg, transition: "background 0.4s ease, color 0.4s ease" }}
            >
              Start audit
