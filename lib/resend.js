...
const fromEmail = process.env.RESEND_FROM_EMAIL || "Veridex <noreply@veridex.dev>";
...
<body style="margin:0;padding:0;background:#f5f3ee;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="text-align:center;margin-bottom:32px;">
      <img src="https://veridex.dev/logo.png" alt="Veridex" width="40" height="40" style="border-radius:10px;" />
    ...
    <div style="margin-top:32px;text-align:center;">
      ...
      <div style="margin-top:28px;padding-top:20px;border-top:1px solid #e8e4dc;">
        ...
        <p style="margin:6px 0 0;font-size:11px;color:#b0aa9f;">
          You received this because you ran an audit on veridex.dev.
          <br/>
          <a href="https://veridex.dev" style="color:#8a8478;text-decoration:underline;">veridex.dev</a>
        </p>
      </div>
    </div>
...
<body style="margin:0;padding:0;background:#f5f3ee;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:40px 32px;border:1px solid #e8e4dc;">
      ...
      <!-- CTA -->
      <div style="text-align:center;">
        <a href="https://veridex.dev/audit" style="display:inline-block;background:#0a0907;color:#f3ead8;text-decoration:none;padding:14px 32px;border-radius:999px;font-size:14px;font-weight:600;">
          Run Another Audit →
        </a>
      </div>
    </div>
    ...
    <div style="margin-top:32px;text-align:center;">
      ...
      <div style="margin-top:20px;padding-top:20px;border-top:1px solid #e8e4dc;">
        ...
        <p style="margin:6px 0 0;font-size:11px;color:#b0aa9f;">
          You received this because you requested a consultation on veridex.dev.
          <br/>
          <a href="https://veridex.dev" style="color:#8a8478;text-decoration:underline;">veridex.dev</a>
        </p>
      </div>
