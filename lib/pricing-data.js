...
export const AI_TOOLS = {
  cursor: {
    ...
    mono: "Cu",
    tint: "#d8d8d8",
    icon: "https://cdn.simpleicons.org/cursor/f3ead8",
    category: "coding",
    plans: {
      hobby: { name: "Hobby", price: 0, label: "Free" },
      pro: { name: "Pro", price: 20, label: "$20/user/mo" },
      proPlus: { name: "Pro+", price: 60, label: "$60/user/mo" },
      ultra: { name: "Ultra", price: 200, label: "$200/user/mo" },
  ...
  github_copilot: {
    ...
    mono: "GC",
    tint: "#bfbfbf",
    icon: "https://cdn.simpleicons.org/githubcopilot/f3ead8",
    category: "coding",
    plans: {
      free: { name: "Free", price: 0, label: "Free" },
      pro: { name: "Pro", price: 10, label: "$10/user/mo" },
      proPlus: { name: "Pro+", price: 39, label: "$39/user/mo" },
  ...
  claude: {
    ...
    mono: "Cl",
    tint: "#c97b4e",
    icon: "https://cdn.simpleicons.org/claude/f3ead8",
    category: "general",
    plans: {
      free: { name: "Free", price: 0, label: "Free" },
      pro: { name: "Pro", price: 20, label: "$20/user/mo" },
      max5x: { name: "Max 5x", price: 100, label: "$100/user/mo" },
      max20x: { name: "Max 20x", price: 200, label: "$200/user/mo" },
  ...
  anthropic_api: {
    ...
    mono: "An",
    tint: "#c97b4e",
    icon: "https://cdn.simpleicons.org/anthropic/f3ead8",
    category: "api",
    plans: {
  ...
  gemini: {
    ...
    mono: "G",
    tint: "#5a8ef6",
    icon: "https://cdn.simpleicons.org/googlegemini/f3ead8",
    category: "general",
    plans: {
  ...
  windsurf: {
    ...
    mono: "Ws",
    tint: "#4ac9f0",
    icon: "https://cdn.simpleicons.org/windsurf/f3ead8",
    category: "coding",
    plans: {
      free: { name: "Free", price: 0, label: "Free" },
  ...
  perplexity: {
    ...
    mono: "P",
    tint: "#22b8b8",
    icon: "https://cdn.simpleicons.org/perplexity/f3ead8",
    category: "general",
    plans: {
      free: { name: "Free", price: 0, label: "Free" },
      pro: { name: "Pro", price: 20, label: "$20/user/mo" },
  ...
  notion: {
    ...
    mono: "N",
    tint: "#e6e0d0",
    icon: "https://cdn.simpleicons.org/notion/f3ead8",
    category: "general",
    plans: {
  ...
  replit: {
    ...
    mono: "Rp",
    tint: "#f57c4a",
    icon: "https://cdn.simpleicons.org/replit/f3ead8",
    category: "coding",
    plans: {
